            ...
            <div className="row posotion-container" >
                <div className="col-6 about-left-content" style={{ paddingTop: '10rem' }}>
                    ...
                    <div className='p-container'>
                        ...
                        <p className='contact-data' style={{marginTop:'2rem'}}><Image src={place} />Shop No 2, Agar Bazar, Dadar West, Mumbai</p>
                        <p className='contact-data'><Image src={mail} />sales@siddhiconsulting.in</p>
